...
![Status](https://img.shields.io/badge/status-V1%20DQN%20smoke-2E8B57)
![Test](https://img.shields.io/badge/tests-pytest%20passing-4C9A2A)
![RL](https://img.shields.io/badge/RL-DQN%20implemented-F28C28)
...
이 프로젝트에서 DQN은 이미지 픽셀이 아니라 정규화된 재고/시간/트럭 상태를 입력으로 받고, 가능한 action 중 다음 방문 대여소를 선택하는 Q-network로 확장될 예정이다.
